...
func (h *FormHandler[T]) HandleUserRegistration(r *http.Request) (*authentication.User[T], error) {
...
func (h *FormHandler[T]) HandleUserLogin(r *http.Request) (*authentication.User[T], error) {
