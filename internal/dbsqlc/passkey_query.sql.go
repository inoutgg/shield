...
func (q *Queries) CreateUserPasskeyCredential(ctx context.Context, arg CreateUserPasskeyCredentialParams) error {
	_, err := q.db.Exec(ctx, createUserPasskeyCredential,
		arg.ID,
		arg.UserID,
...
func (q *Queries) FindUserWithPasskeyCredentialByEmail(ctx context.Context, email string) (FindUserWithPasskeyCredentialByEmailRow, error) {
	row := q.db.QueryRow(ctx, findUserWithPasskeyCredentialByEmail, email)
